...
import static com.example.demo2.Mark.*;
...
public class Board {
    ...
    public void placeMark(int row, int col, Mark playerMark) {
        if (row >= 0 && row < BOARD_WIDTH && col >= 0 && col < BOARD_WIDTH && board[row][col] == Mark.BLANK) {
